...
class Team {
    ...
    writeToFile = (fileName, data) => {
        ...
        return new Promise((resolve, reject) =>{
            fs.writeFile(fileName, generatePage(data), err =>{
                console.log("trying to write this data and generatePage has run");
                console.log("file name really is: ", fileName);
                if(err){
    ...
    .then(memberData => {
        ...
        if(memberData.confirmAddEmp){
            ...
            console.log("going to write this into a file: ", this);
